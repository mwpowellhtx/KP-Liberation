...
/*
    KPLIB_fnc_hud_onShowFob

    File: fn_hud_onShowFob.sqf
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-04-03 00:31:59
    Last Update: 2021-05-17 14:04:35
    License: GNU General Public License v3.0 - https://www.gnu.org/licenses/gpl-3.0.html
    Public: No

    Description:
        May show the FOB HUD for the given PLAYER.

    Parameters:
        _player - player for whom a FOB HUD may be shown [OBJECT, default: objNull]
...
[
    ...
    , {
        [_x, KPLIB_hudSM_fobReportPrefix] call KPLIB_fnc_string_startsWith;
    } count _overlayKeys
] params [
    Q(_playerIsPlayer)
    , Q(_ctrlCount)
...
// TODO: TBD: is key count necessary? (_keyCount == count KPLIB_hudSM_fobReportKeys) (?)
