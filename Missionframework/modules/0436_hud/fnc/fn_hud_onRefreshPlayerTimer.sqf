...
/*
    ...
    Last Update: 2021-05-17 14:03:55
    ...
    Parameters:
        _player - the player for whom an affixed timer may be refreshed [OBJECT, default: objNull]
        _timerName - the variable name affixed to the player being refreshed [STRING, default: KPLIB_hudSM_dispatchTimer]
        _timerPeriod - a timer period used to create a default timer shape [SCALAR, default: KPLIB_hudSM_dispatchPeriod]
...
params [
    ...
    , [Q(_timerPeriod), KPLIB_hudSM_dispatchPeriod, [0]]
];
