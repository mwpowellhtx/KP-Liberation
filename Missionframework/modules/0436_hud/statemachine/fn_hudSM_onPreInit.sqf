...
/*
    KPLIB_fnc_hudSM_onPreInit

    File: fn_hudSM_onPreInit.sqf
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-04-03 00:31:59
    Last Update: 2021-05-17 14:08:29
...
if (isServer) then {
    ["[fn_hudSM_onPreInit] Initializing...", "PRE] [HUDDISPATCHSM", true] call KPLIB_fnc_common_log;
};
...
if (isServer) then {
    ["[fn_hudSM_onPreInit] Initialized", "PRE] [HUDDISPATCHSM", true] call KPLIB_fnc_common_log;
};
