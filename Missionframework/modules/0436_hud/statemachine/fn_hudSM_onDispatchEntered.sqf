...
/*
    KPLIB_fnc_hudSM_onDispatchEntered

    File: fn_hudSM_onDispatchEntered.sqf
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-04-03 00:31:59
    Last Update: 2021-05-17 14:07:48
...
if (_debug) then {
    ["[fn_hudSM_onDispatchEntered] Entering...", "HUDSM", true] call KPLIB_fnc_common_log;
};
...
if (_debug) then {
    [format ["[fn_hudSM_onDispatchEntered] Fini: [_cid, _standbyStatus, _dispatchStatus, count _standbyReport, count _dispatchReport]: %1"
        , str [_cid, _standbyStatus, _dispatchStatus, count _standbyReport, count _dispatchReport]], "HUDSM", true] call KPLIB_fnc_common_log;
};
