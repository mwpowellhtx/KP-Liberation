...
/*
    KPLIB_fnc_hudSM_onCreateReportContext_initSector

    File: fn_hudSM_onCreateReportContext_initSector.sqf
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-04-03 00:31:59
    Last Update: 2021-05-17 14:07:40
...
if (_debug) then {
    ["[fn_hudSM_onCreateReportContext_initSector] Entering...", "HUDSM", true] call KPLIB_fnc_common_log;
};
...
if (_debug) then {
    [format ["[fn_hudSM_onCreateReportContext_initSector] Fini: [_markerRange, _sectorCapRange, _sectorActRange]: %1"
        , str [_markerRange, _sectorCapRange, _sectorActRange]], "HUDSM", true] call KPLIB_fnc_common_log;
};
