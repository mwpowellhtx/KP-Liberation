...
/*
    KPLIB_fnc_hudSM_onReportSector_gridref

    File: fn_hudSM_onReportSector_gridref.sqf
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-04-03 00:31:59
    Last Update: 2021-05-17 14:10:05
...
if (_debug) then {
    [format ["[fn_hudSM_onReportSector_gridref] Entering: [_markerName]: %1"
...
if (_debug) then {
    [format ["[fn_hudSM_onReportSector_gridref] Fini: [count _compiledReport]: %1"
