/*
    KPLIB_fnc_timers_rebase

    File: fn_timers_rebase.sqf
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-02-03 15:35:44
    Last Update: 2021-02-03 15:35:46
...
// Nothing to rebase when the timer has not started
if (_duration < 0) exitWith {+KPLIB_timers_default};

[_duration, _now - _elapsedTime, _elapsedTime, _timeRemaining];
