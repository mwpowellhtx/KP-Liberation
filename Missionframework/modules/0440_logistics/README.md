...
* `KPLIB_param_logistics_proximityRadius` - used to determine _proximity_ to features such as _roads_, etc, when estimating _approximate actual position_, for use _when mapping progress_, determining transport and resource splat _during ambush losses_, and so forth.
