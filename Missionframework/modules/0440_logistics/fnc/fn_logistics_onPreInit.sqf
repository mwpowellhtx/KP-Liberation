...
KPLIB_logistics_status_ambushedBlocked      = KPLIB_logistics_status_ambushed   + KPLIB_logistics_status_routeBlocked;
...
if (isServer) then {
    ...
    KPLIB_param_logistics_getEndpointIndexes_debug          = false;
