...
// This bundles several of the cross-cutting GARRISON CBA settings across SECTOR TYPE vectors
{
    ...
    if (!(_iedDieSides isEqualTo "" || _iedDieTimes isEqualTo "" || _iedDieOffsets isEqualTo "")) then {
        [
            QSECTORTYPE_PARAM(KPLIB_GARRISON_SECTORTYPE_PARAM_FORMAT_MINE_DIE_SIDES,_sectorType)
            , Q(EDITBOX)
            , [
                localize "STR_KPLIB_SETTINGS_GARRISON_MINE_DIE_SIDES"
        ...
        [
            QSECTORTYPE_PARAM(KPLIB_GARRISON_SECTORTYPE_PARAM_FORMAT_MINE_DIE_TIMES,_sectorType)
            , Q(EDITBOX)
            , [
                localize "STR_KPLIB_SETTINGS_GARRISON_MINE_DIE_TIMES"
                , localize "STR_KPLIB_SETTINGS_GARRISON_DIE_BITS_NEGATIVE_CIV_REP_TT"
            ]
            , localize _categoryKey
            , _iedDieTimes
        ...
        [
            QSECTORTYPE_PARAM(KPLIB_GARRISON_SECTORTYPE_PARAM_FORMAT_MINE_DIE_OFFSETS,_sectorType)
            , Q(EDITBOX)
            , [
                localize "STR_KPLIB_SETTINGS_GARRISON_MINE_DIE_OFFSETS"
                , localize "STR_KPLIB_SETTINGS_GARRISON_DIE_BITS_NEGATIVE_CIV_REP_TT"
            ]
            , localize _categoryKey
            , _iedDieOffsets
...
[
    QMPARAM(_buildingDamageThreshold)
    , Q(SLIDER)
    , [
        localize "STR_KPLIB_SETTINGS_GARRISON_DAMAGED_BUILDING_THRESHOLD"
        , localize "STR_KPLIB_SETTINGS_GARRISON_DAMAGED_BUILDING_THRESHOLD_TT"
    ]
...
[
    ...
    , Q(CHECKBOX)
    , [
        localize "STR_KPLIB_SETTINGS_GARRISON_ASSESS_PARTIAL_BUILDING_DAMAGE"
        , localize "STR_KPLIB_SETTINGS_GARRISON_ASSESS_PARTIAL_BUILDING_DAMAGE_TT"
    ]
    , localize "STR_KPLIB_SETTINGS_GARRISON"
    , false // default
    , 1
...
[
    QMPARAM(_buildingDamagePenaltyPerPos)
    , Q(SLIDER)
    , [
        localize "STR_KPLIB_SETTINGS_GARRISON_BUILDING_DAMAGE_PENALTY_PER_POS"
        , localize "STR_KPLIB_SETTINGS_GARRISON_BUILDING_DAMAGE_PENALTY_PER_POS_TT"
    ]
    , localize "STR_KPLIB_SETTINGS_GARRISON"
