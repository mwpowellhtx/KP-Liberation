...
/*
    ...
    Created: 2018-10-18
    Last Update: 2021-04-21 13:18:14
...
if (_debug) then {
    ["[fn_garrison_onSaveData] Saving...", "SAVE"] call KPLIB_fnc_common_log;
};
...
if (_debug) then {
    ["[fn_garrison_onSaveData] Saved", "SAVE"] call KPLIB_fnc_common_log;
};
