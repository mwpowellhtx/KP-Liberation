...
/*
    ...
    Created: 2018-10-18
    Last Update: 2021-04-14 22:12:27
...
if (_debug) then {
    ["[fn_garrison_onLoadData] Loading...", "SAVE"] call KPLIB_fnc_common_log;
};
...
if (_moduleData isEqualTo []) then {
    ...
    if (_debug) then {
        ["[fn_garrison_onLoadData] Initializing...", "SAVE"] call KPLIB_fnc_common_log;
    };
    ...
    if (_debug) then {
        ["[fn_garrison_onLoadData] Applying...", "SAVE"] call KPLIB_fnc_common_log;
    };
