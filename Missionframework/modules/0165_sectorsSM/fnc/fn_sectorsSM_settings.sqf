...
/*
    ...
    Last Update: 2021-04-13 22:44:37
...
MPARAMSM(_onDeactivatedEntered_debug)                               = true;
MPARAMSM(_onGetContextList_debug)                                   = false;
MPARAMSM(_onGarrisonPending_debug)                                  = true;
MPARAMSM(_onIterating_debug)                                        = true;
MPARAMSM(_onCapturingEntered_debug)                                 = true;
MPARAMSM(_onDeactivating_debug)                                     = true;
MPARAMSM(_onNoOp_debug)                                             = true;
MPARAMSM(_timerHasElapsed_debug)                                    = true;
MPARAMSM(_zeroSitrep_debug)                                         = true;

MPARAMSM(_getStochasticTrigger_debug)                               = true;
