...
/*
    KPLIB_fnc_sectorsSM_onCounterAttackMissionTransit

    File: fn_sectorsSM_onCounterAttackMissionTransit.sqf
...
if (_debug) then {
    [format ["[fn_sectorsSM_onCounterAttackMissionTransit] Fini: [_markerName]: %1"
        , str [_markerName]], "SECTORSSM", true] call KPLIB_fnc_common_log;
};
