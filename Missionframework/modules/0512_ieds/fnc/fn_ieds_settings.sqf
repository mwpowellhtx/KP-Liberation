...
/*
    ...
    Last Update: 2021-06-14 17:09:04
...
MPARAM(_onTriggerActivation_debug)          = false;
MPARAM(_onTriggerSmallCondition_debug)      = false;
MPARAM(_onTriggerBigCondition_debug)        = false;
