...
if (isServer) then {
    ...
    KPLIB_logisticsSM_broadcastLinesTimer                       = "KPLIB_logisticsSM_broadcastLinesTimer";

    KPLIB_logisticsSM_standbyPeriod                             = 1;

    KPLIB_param_logisticsSM_createSM_debug                      = false;
    // KPLIB_param_logisticsSM_gcSM_debug                          = false;
    KPLIB_param_logisticsSM_onPublishLine_debug                 = false;
    KPLIB_param_logisticsSM_onPublishLines_debug                = false;
    ...
    KPLIB_param_logisticsSM_toPendingUnloading_debug            = false;
    KPLIB_param_logisticsSM_toPendingEnRoute_debug              = false;
    KPLIB_param_logisticsSM_toArriving_debug                    = false;
