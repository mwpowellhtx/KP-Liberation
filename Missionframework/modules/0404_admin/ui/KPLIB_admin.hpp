...
class KPLIB_admin {
    ...
    class controls {
        ...
        class KPLIB_ExportButton: KPGUI_PRE_DialogButtonC {
            ...
            y = safeZoneY + safeZoneH * (KP_Y_VAL_C + KP_HEIGHT_TITLE + KP_SPACING_Y);
        ...
        class KPLIB_ImportButton: KPGUI_PRE_DialogButtonC {
            ...
            y = safeZoneY + safeZoneH * (KP_Y_VAL_C + KP_HEIGHT_TITLE + KP_HEIGHT_BUTTON + 2 * KP_SPACING_Y);
        ...
        class KPLIB_DeleteButton: KPGUI_PRE_DialogButtonC {
            ...
            y = safeZoneY + safeZoneH * (KP_Y_VAL_C + KP_HEIGHT_TITLE + 2 * KP_HEIGHT_BUTTON + 3 * KP_SPACING_Y);
        ...
        class KPLIB_WipeButton: KPGUI_PRE_DialogButtonC {
            ...
            y = safeZoneY + safeZoneH * (KP_Y_VAL_C + KP_HEIGHT_TITLE + 3 * KP_HEIGHT_BUTTON + 4 * KP_SPACING_Y);
