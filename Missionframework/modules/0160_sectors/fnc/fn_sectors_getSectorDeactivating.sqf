...
/*
    ...
    Last Update: 2021-04-27 12:54:09
    ...
    Description:
        ...
        when SECTOR SITREP is recalculated for consideration. We also include INTEL OBJECT
        bits in the calculation whether a SECTOR may be DEACTIVATED.
...
[
    ...
    , _namespace getVariable [Q(KPLIB_garrison_intelObjs), []]
] params [
    Q(_blufor)
    , Q(_opfor)
