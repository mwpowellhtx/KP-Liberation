...
#define KPLIB_LOGISTICSMGR_LNB_TELEMETRY_W      KPX_GETW_VWGS(KPLIB_LOGISTICSMGR_CTRLAREA_W,13,40,KPX_SPACING_W)
#define KPLIB_LOGISTICSMGR_LNB_TELEMETRY_H      KPX_GETH_VHGS(KPLIB_LOGISTICSMGR_CTRLAREA_H,4,19,KPX_SPACING_H)
...
#define KPLIB_LOGISTICSMGR_LNB_CONVOY_H         KPX_GETH_VHGS(KPLIB_LOGISTICSMGR_CTRLAREA_H,5,19,KPX_SPACING_H)

#define KPLIB_LOGISTICSMGR_BTN_TRANSPORT_Y      KPLIB_LOGISTICSMGR_LNB_CONVOY_Y
