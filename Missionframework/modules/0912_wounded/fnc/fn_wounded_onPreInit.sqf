...
/*
    KPLIB_fnc_wounded_onPreInit

    File: fn_wounded_onPreInit.sqf
...
if (isServer) then {
    ["[fn_wounded_onPreInit] Initializing...", "PRE] [WOUNDED", true] call KPLIB_fnc_common_log;
};
...
if (isServer) then {
    ["[fn_wounded_onPreInit] Initialized", "PRE] [WOUNDED", true] call KPLIB_fnc_common_log;
};
