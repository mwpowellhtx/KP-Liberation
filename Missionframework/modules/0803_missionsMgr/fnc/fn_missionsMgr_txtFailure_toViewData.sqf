...
/*
    KPLIB_fnc_missionsMgr_txtFailure_toViewData

    File: fn_missionsMgr_txtFailure_toViewData.sqf
    ...
    Description:
        Dissects the MISSION TUPLE for its current FAILURE TEXT element.

    Parameter(s):
        _mission - a MISSION TUPLE array [ARRAY, default: []]

    Returns:
        The FAILURE TEXT element [STRING]
 */
