...
class KPLIB_missionsSM {
    ...
    class KPLIB_missionsSM_state_rebasing {
        onStateEntered = "KPLIB_fnc_missionsSM_onRebasingEntered";
        onState = "[_this, 'rebasing'] call KPLIB_fnc_missionsSM_onNoOp";

        class KPLIB_logisticsSM_transit_onStandby {
            targetState = "KPLIB_logisticsSM_state_standby";
            condition = "[_this] call KPLIB_fnc_logistics_checkStatus";
    ...
    class KPLIB_logisticsSM_state_standby {
        ...
        class KPLIB_logisticsSM_transition_toPendingLoading {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "[_this, KPLIB_logistics_status_loading] call KPLIB_fnc_logistics_checkStatus";
    ...
    class KPLIB_logisticsSM_state_pending {
        ...
        class KPLIB_logisticsSM_transit_onLoading {
            ...
            condition = "([_this] call KPLIB_fnc_logistics_timerHasElapsed) \
                && ([_this, KPLIB_logistics_status_loading] call KPLIB_fnc_logistics_checkStatus)";
        ...
        class KPLIB_logisticsSM_transit_onUnloading {
            ...
            condition = "([_this] call KPLIB_fnc_logistics_timerHasElapsed) \
                && ([_this, KPLIB_logistics_status_unloading] call KPLIB_fnc_logistics_checkStatus)";
    ...
    class KPLIB_logisticsSM_state_loading {
        ...
        class KPLIB_logisticsSM_transit_onPendingNoResource {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "[_this, KPLIB_logistics_status_noResource] call KPLIB_fnc_logistics_checkStatus";
        ...
        class KPLIB_logisticsSM_transit_onPendingLoading {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "([_this, KPLIB_logistics_status_loading] call KPLIB_fnc_logistics_checkStatus) \
                && !([_this, KPLIB_logistics_status_noResource] call KPLIB_fnc_logistics_checkStatus)";
    ...
    class KPLIB_logisticsSM_state_enRoute {
        ...
        class KPLIB_logisticsSM_onAmbushed {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "[_this, KPLIB_logistics_status_ambushed] call KPLIB_fnc_logistics_checkStatus";
            onTransition = "[_this, 'onambushed'] call KPLIB_fnc_logisticsSM_onNoOp";
        };

        class KPLIB_logisticsSM_transit_onRouteBlocked {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "([_this, KPLIB_logistics_status_routeBlocked] call KPLIB_fnc_logistics_checkStatus) \
                && !([_this, KPLIB_logistics_status_ambushed] call KPLIB_fnc_logistics_checkStatus)";
        ...
        class KPLIB_logisticsSM_onContinueMission {
            ...
            condition = "([_this, KPLIB_logistics_status_enRoute] call KPLIB_fnc_logistics_checkStatus) && !( \
                    ([_this, KPLIB_logistics_status_ambushed] call KPLIB_fnc_logistics_checkStatus) \
                        || ([_this, KPLIB_logistics_status_routeBlocked] call KPLIB_fnc_logistics_checkStatus) \
                )";
        ...
        class KPLIB_logisticsSM_transit_onPendingUnloading {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "[_this, KPLIB_logistics_status_unloading] call KPLIB_fnc_logistics_checkStatus";
    ...
    class KPLIB_logisticsSM_state_unloading {
        ...
        class KPLIB_logisticsSM_transit_onPendingNoSpace {
            targetState = "KPLIB_logisticsSM_state_pending";
            condition = "[_this, KPLIB_logistics_status_noSpace] call KPLIB_fnc_logistics_checkStatus";
