...
// Assault boat asset spawning in the boat racks of the Liberty.
KPLIB_PRST_SETVAR("addBoat", "B_Boat_Transport_01_F");
// MH-9 Hummingbird light rotary asset spawning at the Operation Base.
KPLIB_PRST_SETVAR("addRotaryLight", "B_Heli_Light_01_F");
// UH-80 Ghost Hawk rotary asset spawning in the Operation Base.
KPLIB_PRST_SETVAR("addRotaryUnarmed", "B_Heli_Transport_01_F");
// AH-99 Blackfoot with dynamic loadout capability spawning in the Operation Base.
KPLIB_PRST_SETVAR("addRotaryArmed", "B_Heli_Attack_01_dynamicLoadout_F");
...
//// TODO: TBD: continuing the tradition of "everyman" vics...
KPLIB_PRST_CAT_ADD("vehLightUnarmed", "B_Quadbike_01_F",                       0,    0,    0);   // Quadbike
KPLIB_PRST_CAT_ADD("vehLightUnarmed", "B_LSV_01_unarmed_F",                    0,    0,    0);   // Prowler
KPLIB_PRST_CAT_ADD("vehLightUnarmed", "B_MRAP_01_F",                           0,    0,    0);   // Hunter
