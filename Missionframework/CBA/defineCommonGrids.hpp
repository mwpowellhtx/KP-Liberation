/*
    Using the CBA defineCommonGrids.hpp as a basis for a more extensible UI specification.

    File: CBA_defineCommonGrids.hpp
    Author: Michael W. Powell [22nd MEU SOC]
    Created: 2021-02-06 20:37:10
    Last Update: 2021-02-06 20:37:12
    License: GNU General Public License v3.0 - https://www.gnu.org/licenses/gpl-3.0.html

    Description:
        CBA 'defineCommonGrids.hpp' literally saved from the CBA project.

    References:
        https://github.com/CBATeam/CBA_A3/blob/master/include/a3/ui_f/hpp/defineCommonGrids.inc
